...
import { TrendingUp, Trophy, Waves, Zap } from 'lucide-react';
...
type NatacaoSectionProps = {
  ...
  showDistNatacao: boolean;
  setShowDistNatacao: Dispatch<SetStateAction<boolean>>;
};

export default function NatacaoSection({
  stats,
  isDark,
  showPaceNatacao,
  setShowPaceNatacao,
